...
com.romanysoft.app.macos.TryToALAC

1.14.0326



##Thank you for using our 'TryToALAC' app. ## 

==========================================================
TryToALAC which makes It's easy and smart to try convert other format to ALAC(.m4a). 

===================================================================================================================
##Features in current stable release## 
1.support some popular audio format like: 
8SVX exponential
8SVX fibonacci
AAC+
AAC
...
You can see http://en.wikipedia.org/wiki/Audio_file_format 

2.easy and smart. can intelligent recognition. 
3.support OSX 10.6,10.7,10.8,10.9 
4.convert process, the progress shows



Keywords:
convert,convert to ALAC,ALAC,alac,audio convert,audio,to m4a,m4a
